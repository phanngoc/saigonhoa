...
<?php _e('Notification E-mail', 'woocommerce-checkout-manager-pro');  ?></h3>
...
<input name="wccs_settings[checkness][wooccm_notification_email]" type="text" value="<?php echo $options['checkness']['wooccm_notification_email']; ?>" />
	...
	<div class="section">
<h3 class="heading"><?php _e('Products', 'woocommerce-checkout-manager-pro');  ?></h3>

<div class="info-of"><?php _e('Allow File Upload', 'woocommerce-checkout-manager-pro');  ?></div>
<div class="option allow" >
<input name="wccs_settings[change][allow_file_upload]" placeholder="Enter Product ID(s); Example: 1674, 1423, 1234" type="text" value="<?php echo $options['change']['allow_file_upload']; ?>" />
	...
	<div class="section">
<div class="info-of"><?php _e('Deny File Upload', 'woocommerce-checkout-manager-pro');  ?></div>
<div class="option" >
<input name="wccs_settings[change][deny_file_upload]" placeholder="Enter Product ID(s); Example: 1674, 1423, 1234" type="text" value="<?php echo $options['change']['deny_file_upload']; ?>" />
</div>
	</div>


	<div class="section">
<h3 class="heading"><?php _e('Categories', 'woocommerce-checkout-manager-pro');  ?></h3>

<div class="info-of"><?php _e('Allow File Upload', 'woocommerce-checkout-manager-pro');  ?></div>
<div class="option allow" >
<input name="wccs_settings[change][allow_file_upload_cat]" placeholder="Enter Category Slug(s); Example: my-cat, flowers_in" type="text" value="<?php echo $options['change']['allow_file_upload_cat']; ?>" />
</div>
	</div>
...
<div class="info-of"><?php _e('Deny File Upload', 'woocommerce-checkout-manager-pro');  ?></div>
<div class="option" >
		<input name="wccs_settings[change][deny_file_upload_cat]" placeholder="Enter Category Slug(s); Example: my-cat, flowers_in" type="text" value="<?php echo $options['change']['deny_file_upload_cat']; ?>" />
</div>
	</div>
